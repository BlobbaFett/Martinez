...
def print_death_age(people_dict):
    ...
    for i in people_dict:
        ...
        print(f'{name}, died at {death} years old')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for i in marriages_dict:
        ...
        marr_year = wedding[WEDDING_YEAR_INDEX]
        ...
        husband_age = marr_year - husband[BIRTH_YEAR_INDEX]
        wife_age = marr_year - wife[BIRTH_YEAR_INDEX] 
        
        print(f'{husband_name} were married at {husband_age}')
        print(f'{wife_name} were married at {wife_age}')   
